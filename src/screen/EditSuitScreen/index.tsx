...
export default function EditSuitScreen() {
  ...
  const handleSave = async (
    ...
    if (!name.trim()) {
      Alert.alert(i18n.t("name_required"), i18n.t("enter_name"));
      return;
    }
  ...
  return (
    <ThemedSafeAreaView style={{ flex: 1 }}>
      ...
      <SuitNameModal
        ...
        saveButtons={[
          { label: i18n.t("save_changes"), value: "save_changes" },
          { label: i18n.t("copy_cloud"), value: "copy_cloud" },
          { label: i18n.t("copy_local"), value: "copy_local" },
        ]}
